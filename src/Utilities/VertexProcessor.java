...
public class VertexProcessor {
    ...
    public Matrix4x4 TEMP = new Matrix4x4();
    public Matrix4x4 tolight = new Matrix4x4();
    ...
    public void PrepareTransformation() {
        tolight= world2view.multiplaymatrix(TEMP);
    ...
    public List<Triangle> TransformTriangles(List<Triangle> objects,Light L) {
        List<Triangle> result = new ArrayList<Triangle>();
        for (Triangle tr : objects) {

            result.add(new Triangle(Transform(tr.a), Transform(tr.b), Transform(tr.c), tr.n1,tr.n2,tr.n3,L, width, height));
        }
        return result;
    }
    ...
    {
        return new Vector(tolight.matrix[0].x*n.x+tolight.matrix[1].x*n.x+tolight.matrix[2].x*n.x,
                tolight.matrix[0].y*n.y+tolight.matrix[1].y*n.y+tolight.matrix[2].y*n.y,
                tolight.matrix[0].z*n.z+tolight.matrix[1].z*n.z+tolight.matrix[2].z*n.z);
